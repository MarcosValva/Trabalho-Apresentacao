...
/// Programa principal que permite ao usuário escolher entre calcular o custo de aluguel de carro ou resolver uma equação quadrática usando Bhaskara.
class Program
{
    static void Main()
    {
        ...
        do
        {
            ...
            switch (opcao)
            {
                // Caso o usuário escolha sair, exibe mensagem de fim e aguarda a tecla para encerrar o programa
                case 0:
                ...
                case 2:
                    ...
                    // Mantém a tela aberta até que o usuário pressione uma tecla
                    Console.WriteLine("Pressione qualquer tecla para voltar ao menu principal...");
                    Console.ReadKey();
                    break;
